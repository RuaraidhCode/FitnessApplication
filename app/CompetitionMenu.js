...
const handleCreateCompetitionBackend = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Competition Menu</Text>
      ...
      >
                    ...
                    {competitionListData.map((competition, index) => (
                      <TouchableOpacity
                        ...
                        onPress={() => {toggleCardExpansion(index);
                                        ...
                                        setSelectedCategory(competition.comp_category);
                                       }}
                                    >
                        <View style={styles.cardHeader}>
                         <Text style={styles.cardTitle}>{competition.comp_name}</Text>
                         <Text style={styles.cardType} >{competition.comp_type}</Text>
                        </View>
                        {expandedCards[index] && (
                          <View style={styles.expandedContentContainer}>
                            ...
                            <Text style={styles.expandedContent}>Type: {competition.comp_category}</Text>
                            <Text>{"\n"}</Text>
        ...
        <TouchableOpacity style={styles.buttonContainer} onPress={() => navigation.navigate('CompetitionHistory')}>
          <Text style={styles.buttonText}>Competition History</Text>
        </TouchableOpacity>
