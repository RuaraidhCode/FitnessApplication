        ...
        <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.BMIInfoContainer}>
                <Text style={styles.BMIInfoText}>Underweight: BMI less than 18.5</Text>
                <Text style={styles.BMIInfoText}>Normal Weight: BMI 18.5 to 24.9</Text>
                <Text style={styles.BMIInfoText}>Overweight: BMI 25 to 29.9</Text>
                <Text style={styles.BMIInfoText}>Obesity Class I: BMI 30 to 34.9</Text>
                <Text style={styles.BMIInfoText}>Obesity Class II: BMI 35 to 39.9</Text>
                <Text style={styles.BMIInfoText}>Obesity Class III (Morbid Obesity): BMI 40 or greater</Text>
              </View>
              <TouchableOpacity
